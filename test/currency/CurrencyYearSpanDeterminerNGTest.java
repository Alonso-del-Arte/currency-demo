...
public class CurrencyYearSpanDeterminerNGTest {
    ...
    @Test
    public void testDetermineYearSpanFrenchFranc() {
        Currency currency = Currency.getInstance("FRF");
        Year begin = Year.of(1960);
        YearSpan expected = new YearSpan(begin, EURO_YEAR_ZERO);
        YearSpan actual 
                = CurrencyYearSpanDeterminer.determineYearSpan(currency);
        String message = "Currency " + currency.getDisplayName() + " (" 
    ...
    @Test
    public void testDetermineYearSpanGreekDrachma() {
        Currency currency = Currency.getInstance("GRD");
        Year begin = Year.of(1833);
        YearSpan expected = new YearSpan(begin, EURO_YEAR_ZERO);
        YearSpan actual 
                = CurrencyYearSpanDeterminer.determineYearSpan(currency);
        String message = "Currency " + currency.getDisplayName() + " (" 
    ...
    @Test
    public void testDetermineYearSpanIrishPound() {
        Currency currency = Currency.getInstance("IEP");
        Year begin = Year.of(1928);
        YearSpan expected = new YearSpan(begin, EURO_YEAR_ZERO);
        YearSpan actual 
                = CurrencyYearSpanDeterminer.determineYearSpan(currency);
        String message = "Currency " + currency.getDisplayName() + " (" 
    ...
    @Test
    public void testDetermineYearSpanItalianLira() {
        Currency currency = Currency.getInstance("ITL");
        Year begin = Year.of(1861);
        YearSpan expected = new YearSpan(begin, EURO_YEAR_ZERO);
        YearSpan actual 
                = CurrencyYearSpanDeterminer.determineYearSpan(currency);
        String message = "Currency " + currency.getDisplayName() + " (" 
    ...
    @Test
    public void testDetermineYearSpanLithuanianLitas() {
        Currency currency = Currency.getInstance("LTL");
        Year begin = Year.of(1993);
        Year end = Year.of(2015);
        YearSpan expected = new YearSpan(begin, end);
        YearSpan actual 
                = CurrencyYearSpanDeterminer.determineYearSpan(currency);
        String message = "Currency " + currency.getDisplayName() + " (" 
    ...
    @Test
    public void testDetermineYearSpanSlovenianTolar() {
        Currency currency = Currency.getInstance("SIT");
        Year begin = Year.of(1991);
        Year end = Year.of(2007);
        YearSpan expected = new YearSpan(begin, end);
        YearSpan actual 
                = CurrencyYearSpanDeterminer.determineYearSpan(currency);
        String message = "Currency " + currency.getDisplayName() + " (" 
