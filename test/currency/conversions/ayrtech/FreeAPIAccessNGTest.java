...
public class FreeAPIAccessNGTest {
    ...
    @Test
    public void testGetRateCanInvertWithoutAPICall() {
        AccessWithAPICallCounter instance = new AccessWithAPICallCounter();
    ...
    @Test
    public void testGetRateUnwrappedCanInvertBaseCurrencyToTarget() {
        for (ConversionRateQuote quote : QUOTE_MAP.values()) {
            CurrencyPair currencies = quote.getCurrencies().flip();
            Currency source = currencies.getFromCurrency();
            Currency target = currencies.getToCurrency();
    ...
    @Test
    public void testGetRateDiffBaseCurrencyCanInvert() {
        Currency base = CurrencyChooser.chooseCurrencyOtherThan(U_S_DOLLARS);
        AccessWithAPICallCounter instance = new AccessWithAPICallCounter(base);
        int initialNumberOfCalls = instance.callCountSoFar;
        Map<CurrencyPair, ConversionRateQuote> quoteMap = makeQuoteMap(base);
    ...
    @Test
    public void testGetRateUnwrappedDiffBaseCurrencyCanInvert() {
        Currency base = CurrencyChooser.chooseCurrencyOtherThan(U_S_DOLLARS);
        AccessWithAPICallCounter instance = new AccessWithAPICallCounter(base);
        int initialNumberOfCalls = instance.callCountSoFar;
        Map<CurrencyPair, ConversionRateQuote> quoteMap = makeQuoteMap(base);
