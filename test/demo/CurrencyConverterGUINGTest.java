...
public class CurrencyConverterGUINGTest implements ItemListener {
    ...
    @Test
    public void testGetPairAuxConstructorInstance() {
        CurrencyConverterGUI instance 
                = new CurrencyConverterGUI(MOCK_CONVERTER);
        Set<Currency> set = new HashSet<>(ALLOWED_CURRENCIES);
        Currency from = CurrencyChooser.chooseCurrency(set);
        Currency to = CurrencyChooser.chooseCurrencyOtherThan(from, set);
        instance.activate();
    ...
    @Test
    public void testGetProviderAuxConstructor() {
    ...
    @Test
    public void testNotVisibleBeforeActivationZeroParamConstructor() {
        JFrame instance = new CurrencyConverterGUI();
        boolean visible = instance.isVisible();
        assert !visible : "Converter shouldn't be visible before activation";
    }
        
    @Test
    public void testNotVisibleBeforeActivationAuxConstructor() {
        JFrame instance = new CurrencyConverterGUI(MOCK_CONVERTER);
        boolean visible = instance.isVisible();
        assert !visible : "Converter shouldn't be visible before activation";
    }
    ...
    public void testVisibleAfterActivationZeroParamConstructor() {
        ...
        instance.activate();
        boolean visible = instance.isVisible();
        assert visible : "Converter should be visible after activation";
    }
    
    @Test
    public void testVisibleAfterActivationAuxConstructor() {
        CurrencyConverterGUI instance 
                = new CurrencyConverterGUI(MOCK_CONVERTER);
        instance.activate();
        boolean visible = instance.isVisible();
    ...
    @Test
    public void testVisibleAfterActivation() {
        Currency from = CurrencyChooser.chooseCurrency(ALLOWED_CURRENCIES);
        Currency to = CurrencyChooser.chooseCurrencyOtherThan(from, 
                ALLOWED_CURRENCIES);
        CurrencyPair currencies = new CurrencyPair(from, to);
    ...
    public void testConstructorRejectsNullConverter() {
        ...
        Currency to = CurrencyChooser.chooseCurrencyOtherThan(from, 
                ALLOWED_CURRENCIES);
        CurrencyPair currencies = new CurrencyPair(from, to);
        String msg = "Pair " + currencies.toString() 
                + " with null converter should cause exception";
        Throwable t = assertThrows(() -> {
            JFrame instance = new CurrencyConverterGUI(currencies, null);
            System.out.println(msg + ", not created instance " 
                    + instance.toString());
        }, NullPointerException.class, msg);
        String excMsg = t.getMessage();
