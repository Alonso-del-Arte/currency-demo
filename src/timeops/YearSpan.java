...
public class YearSpan implements Comparable<YearSpan>, DurationalSpan {
    ...
    public boolean isAfter(Year year) {
        Year rightBeforeBegin = this.start.minusYears(1);
        return year.isBefore(rightBeforeBegin);
    }
    ...
    public Duration getDuration() {
        ...
        int leapDays = 0;
        int value = this.start.getValue();
        int remainder = value % 4;
        int isoYear = value + ((remainder == 0) ? 0 : 4 - remainder);
